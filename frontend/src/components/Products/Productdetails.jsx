            ...
            {selectedproduct.images.map((image, index) => (
              <img
                ...
                className={`w-20 h-20 object-cover rounded-lg cursor-pointer border hover:scale-105 transition ${
                  mainimage === image.url ? 'ring-2 ring-blue-500' : ''
                }`}
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border ${
                        isSelected ? 'border-4 ring-black' : 'border-gray-300'
                      }`}
                      style={{
                ...
                {selectedproduct.size.map((size) => {
                  ...
                  return (
                    <button
                      ...
                      className={`
                        min-w-[100px] px-4 py-2 rounded border text-sm text-center break-words
                        ${isSelected
